      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="neon-border rounded-lg p-8 text-center">
            ...
            <h3 className="text-2xl font-gaming font-bold mb-4" data-testid="text-twitch-title">TWITCH</h3>
            ...
            <Button 
              onClick={openTwitch}
              className="bg-purple-600 hover:bg-purple-700 text-white neon-glow w-full"
          ...
          <div className="neon-border rounded-lg p-8 text-center">
            ...
            <h3 className="text-2xl font-gaming font-bold mb-4" data-testid="text-youtube-title">YOUTUBE</h3>
            <p className="text-muted-foreground mb-6">
            ...
            <Button 
              onClick={openYouTube}
              className="bg-red-600 hover:bg-red-700 text-white neon-glow w-full"
